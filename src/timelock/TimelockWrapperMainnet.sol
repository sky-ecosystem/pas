...
interface ControllerLike {
    // Shared functions (Spark v1.9.0 & Grove v1.8.0)
...
// Spark Mainnet controller aligned to v1.9.0: https://github.com/sparkdotfi/spark-alm-controller/blob/3dbc7cb01739e91dad61a75cda8d7c84b4474e0b/src/MainnetController.sol
...
contract TimelockWrapperMainnet {
    ...
    function setOTCRechargeRate(
        ...
        bytes memory controllerData = abi.encodeCall(
            ControllerLike.setOTCRechargeRate,
    ...
    function setOTCWhitelistedAsset(
        ...
        bytes memory controllerData = abi.encodeCall(
            ControllerLike.setOTCWhitelistedAsset,
            (exchange, asset, isWhitelisted)
        );
        bytes memory payload = abi.encodeCall(BeamStateLike.addInitControllerActions, (controllerData, controller));
    ...
    function setUniswapV4TickLimits(
        ...
        bytes memory controllerData = abi.encodeCall(
            ControllerLike.setUniswapV4TickLimits,
